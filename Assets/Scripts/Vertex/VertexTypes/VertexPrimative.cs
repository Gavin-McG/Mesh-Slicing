...
namespace MeshSlicing.Vertex
{
    ...
    using TexCoord = TexCoord2;
    using Vertex = VertexPrimative;


    [Serializable, StructLayout(LayoutKind.Sequential), VertexVariant]
    public struct VertexPrimative :
        ...
        ITangent<Vertex, TexCoord>
    {
        ...
        //constructors
        public VertexPrimative(Vector3 position, Vector3 normal, Vector4 tangent, TexCoord uvs)
        {
        ...
        static VertexAttributeDescriptor[] VertexBufferDescriptors => new VertexAttributeDescriptor[]
            ...
            new VertexAttributeDescriptor(VertexAttribute.TexCoord1, VertexAttributeFormat.Float32, dimension:2, stream:0),
            };
