...
using Vertex = VertexStandardRig;


[Serializable, StructLayout(LayoutKind.Sequential), VertexVariant]
public struct VertexStandardRig :
    ...
    IBoneWeights<Vertex, TexCoord>
{
    ...
    //constructors
    public VertexStandardRig(Vector3 position, Vector3 normal, Vector4 tangent, TexCoord uvs, BoneWeight boneWeights)
    {
